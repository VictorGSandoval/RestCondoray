...
values
(1,"lUCIO CARLOS","HUAMAN TIRADO","MASCULINO",983654123,10,10),
(2,"JOSE LUIS","RIVERA YARIHUAMAN","MASCULINO",987309182,9,9),
(3,"XIOMARA MAYLEE","VICUÑA TIRADO","FEMENINO",982748192,8,8),
(4,"CARLA","VICENTE LUYO","FEMENINO",987126345,7,7),
(5,"NOE","YALLE MEZA","MASCULINO",908721341,6,6),
(6,"ZECARLOS","CUYA VICENTE","MASCULINO",981056182,5,5),
(7,"MARIA","PEÑA TIRADO","FEMENINO",981067182,4,4),
(8,"JESUS","SANCHEZ GAMEZ","MASCULINO",971065172,3,3),
(9,"DIEGO","HUAPAYA","MASCULINO",989182103,2,2),
(10,"JEAN","SIMON ROJAS","MASCULINO",998139182,1,1);
select * from PERSONA;
...
insert into USUARIO
(IDUSU,IDEPER,NOMPER,PASPER)
values
(1,1,"XIOMARA","XIOMARA1234"),
(2,2,"CARLOS","CARLOS8971"),
(3,3,"JESUS","JESUSU8778"),
(4,4,"MIGUEL","MIGUEL1784"),
(5,5,"VICTOR","VICTOR67614"),
(6,6,"ANGELA","ANGELA1341"),
(7,7,"DIEGO","DIEGO9874"),
(8,8,"JOSE","JOSESITOMASNA"),
(9,9,"CLARA","CLARA8874"),
(10,10,"CLEYSI","CLEYSI89784");
select * from USUARIO;
